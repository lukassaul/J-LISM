...
public class ImpedSpecRegression extends Regression{
    ...
    private Vector<Object> constraints = null;          // user added constraints
    ...
    Vector<Object> results = null;                      // Vector with elements
    ...
    public void addNewConstraint(int parameter, int direction, double boundary){
        this.constraints.addElement(new Integer(parameter));
        this.constraints.addElement(new Integer(direction));
        this.constraints.addElement(new Double(boundary));
    ...
    public void addNewConstraint(String parameterSymbol, int direction, double boundary){
        ...
        this.constraints.addElement(new Integer(parameterNumber));
        this.constraints.addElement(new Integer(direction));
        this.constraints.addElement(new Double(boundary));
        this.numberOfAddedConstraints++;
        this.constraintsAdded = true;
    ...
    public Vector<Object> regression(){
       ...
       // check initial estimates have been provided
        ...
        this.results.addElement(new Integer(this.numberOfFrequencies));
        this.results.addElement(new Integer(this.numberOfParameters));
        this.results.addElement(new Integer(this.degreesOfFreedom));
        this.results.addElement(this.parameterSymbols);
        this.results.addElement((double[])this.initialEstimates.clone());
        this.results.addElement((double[])this.initialSteps.clone());
        ...
        if(this.constraintsAdded){
            ...
            for(int i=0; i<this.numberOfAddedConstraints; i++){
                int parameter = ((Integer)constraints.elementAt(index)).intValue();
                param[i] = parameter;
                index++;
                int direction = ((Integer)constraints.elementAt(index)).intValue();
                direct[i] = direction;
                index++;
                double boundary = ((Double)constraints.elementAt(index)).doubleValue();
                bound[i] = boundary;
                index++;
        ...
        this.results.addElement(this.bestEstimates);
        this.standardDeviations = this.getCoeffSd();
        this.results.addElement(this.standardDeviations);
        this.coefficientsOfVariation = this.getCoeffVar();
        this.results.addElement(this.coefficientsOfVariation);
        this.correlationCoefficients = this.getCorrCoeffMatrix();
        this.results.addElement(this.correlationCoefficients);
        ...
        this.results.addElement(this.preMinimumGradients);
        this.results.addElement(this.postMinimumGradients);
        this.sumOfSquares = this.getSumOfSquares();
        this.results.addElement(new Double(this.sumOfSquares));
        this.reducedSumOfSquares = this.sumOfSquares/this.degreesOfFreedom;
        this.results.addElement(new Double(this.reducedSumOfSquares));
        if(this.weightsSet){
            this.chiSquare = this.getChiSquare();
            this.results.addElement(new Double(this.chiSquare));
            this.reducedChiSquare = this.getReducedChiSquare();
            this.results.addElement(new Double(this.reducedChiSquare));
        }
        else{
           this.results.addElement(null);
           this.results.addElement(null);
        }
        this.numberOfIterations2 = this.getNiter();
        this.results.addElement(new Integer(this.numberOfIterations1));
        this.results.addElement(new Integer(this.numberOfIterations2));
        this.results.addElement(new Integer(this.maximumIterations));
        this.results.addElement(this.dataEnteredType[this.dataEnteredTypePointer]);

        this.results.addElement(this.frequencies);
        this.results.addElement(this.log10frequencies);
        this.results.addElement(this.omegas);
        this.results.addElement(this.log10omegas);
        this.results.addElement(this.impedanceMagnitudes);
        this.results.addElement(this.impedancePhasesRad);
        this.results.addElement(this.impedancePhasesDeg);
        this.results.addElement(this.impedances);
        this.results.addElement(this.realZ);
        this.results.addElement(this.imagZ);
        ...
        this.results.addElement(this.calculatedRealZ);
        this.results.addElement(this.calculatedImagZ);
        ...
        this.results.addElement(this.realZresiduals);
        this.results.addElement(this.imagZresiduals);

       if(this.weightsSet){
            switch(this.dataEnteredTypePointer){
                case 0:     this.results.addElement(this.realVweights);
                            this.results.addElement(this.imagVweights);
                            break;
                case 1:     this.results.addElement(this.voltageWeights);
                            this.results.addElement(null);
                            break;
                case 2:     this.results.addElement(this.voltageMagnitudeWeights);
                            this.results.addElement(this.voltagePhaseWeightsRad);
                            break;
                case 3:     this.results.addElement(this.voltageMagnitudeWeights);
                            this.results.addElement(this.voltagePhaseWeightsDeg);
                            break;
                case 4:     this.results.addElement(this.realZweights);
                            this.results.addElement(this.imagZweights);
                            break;
                case 5:     this.results.addElement(this.impedanceWeights);
                            this.results.addElement(null);
                            break;
                case 6:     this.results.addElement(this.impedanceMagnitudeWeights);
                            this.results.addElement(this.impedancePhaseWeightsRad);
                            break;
                case 7:     this.results.addElement(this.impedanceMagnitudeWeights);
                            this.results.addElement(this.impedancePhaseWeightsDeg);
                            break;
                default:    this.results.addElement(null);
                            this.results.addElement(null);
            }
            this.results.addElement(this.realZweights);
            this.results.addElement(this.imagZweights);
        }
        else{
            for(int i=0; i<4; i++)this.results.addElement(null);
        }
        ...
        this.results.addElement(this.calculatedImpedances);
        this.results.addElement(this.calculatedImpedanceMagnitudes);
        this.results.addElement(this.calculatedImpedancePhasesRad);
        this.results.addElement(this.calculatedImpedancePhasesDeg);
        ...
        if(this.appliedVoltageSet && this.referenceSet){
            ...
            this.results.addElement(this.calculatedVoltages);
            this.results.addElement(this.calculatedRealV);
            this.results.addElement(this.calculatedImagV);
            this.results.addElement(this.calculatedVoltageMagnitudes);
            this.results.addElement(this.calculatedVoltagePhasesRad);
            this.results.addElement(this.calculatedVoltagePhasesDeg);
        }
        else{
            for(int i=0; i<6; i++)this.results.addElement(null);
        }
