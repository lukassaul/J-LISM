...
*
*       Created: August 2002
*	    Updated: 12 July 2003, 10 May 2005, 2 July 2006, 7 June 2007
*
*       DOCUMENTATION:
        ...
        if(this==null){
            ...
            if(this.checkConsolidate){
                ...
                for(int i=0; i<this.nSeg; i++){
                    Integer holdI1 = (Integer)this.segments.elementAt(j);
                    op.segments.addElement(holdI1);
                    j++;
                    Integer holdI2 = (Integer)this.segments.elementAt(j);
                    op.segments.addElement(holdI2);
                    j++;
                    String holdS = (String)this.segments.elementAt(j);
