...
*
*   Copyright (c) April 2004, November 2006, December 2006, April 2007  Michael Thomas Flanagan
*
*   PERMISSION TO COPY:
...
public class PsRandom{
    ...
    public double nextLogNormalThreePar(double alpha, double beta, double gamma,  int n){
   ...
   public double[] rayleighArray (double sigma, int n){
    ...
    public double[] nextLogistic(double mu, double scale, int n){
        ...
        if(this.methodOptionDecimal==1){
            for(int i=0; i<n; i++){
                ran[i] = 2.0D*scale*Fmath.atanh(2.0D*this.rr.nextDouble() - 1.0D) + mu;
            }
        }
        else{
            for(int i=0; i<n; i++){
                ran[i] = 2.0D*scale*Fmath.atanh(2.0D*this.parkMiller() - 1.0D) + mu;
            }
        }
        return ran;
    }
    ...
    public double nextLogistic(double mu, double scale){
        double ran = 0.0D;
        if(this.methodOptionDecimal==1){
            ran = 2.0D*scale*Fmath.atanh(2.0D*this.rr.nextDouble() - 1.0D) + mu;
        }
        else{
            ran = 2.0D*scale*Fmath.atanh(2.0D*this.parkMiller() - 1.0D) + mu;
        }
        return ran;
    }
    ...
    public double nextF(int nu1, int nu2, int n){
            double ran = Double.NaN;
