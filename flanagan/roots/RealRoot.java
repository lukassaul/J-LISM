...
*
*   DATE:   18 May 2003
*   UPDATE: 22 June 2003, 10 April 2006, 19 October 2007
*
*   DOCUMENTATION:
...
public class RealRoot{
    ...
    // default tolerance used
   	public static double brent(RealRootFunction g, double lower, double upper, double tol){
	    ...
	    while(testConv){
            ...
            iterN++;
            if(iterN>iterMax){
                System.out.println("RealRoot.brent; maximum number of iterations exceeded - root at this point, " + Fmath.truncate(mid, 4) +  ", returned");
	...
	public static double bisect(RealRootFunction g, double lower, double upper, double tol){
        ...
        while(testConv){
            ...
            iterN++;
            if(iterN>iterMax){
                System.out.println("RealRoot.bisect; maximum number of iterations exceeded - root at this point, " + Fmath.truncate(mid, 4) +  ", returned");
                System.out.println("Last mid-point difference = " + Fmath.truncate(diff, 4) +  ", tolerance = " + tol);
                root = mid;
                testConv = false;
            }
	...
	public static double falsePosition(RealRootFunction g, double lower, double upper, double tol){
        ...
        while(testConv){
            ...
            iterN++;
            if(iterN>iterMax){
                System.out.println("RealRoot.falsePosition: maximum number of iterations exceeded - root at this point," + Fmath.truncate(mid, 4) +  ", returned");
                System.out.println("Last mid-point difference = " + Fmath.truncate(diff, 4) +  ", tolerance = " + tol);
                root = mid;
                testConv = false;
            }
    ...
    // tolerance supplied
   	public static double bisectNewtonRaphson(RealRootDerivFunction g, double lower, double upper, double tol){
	    ...
	    while(testConv){
            ...
            iterN++;
            if(iterN>iterMax){
                System.out.println("RealRoot.bisectNetonRaphson: maximum number of iterations exceeded - root at this point, " + Fmath.truncate(mid, 4) +  ", returned");
                System.out.println("Last mid-point difference = " + Fmath.truncate(diff, 4) +  ", tolerance = " + tol);
                root = mid;
                testConv = false;
            }
	...
	public static double newtonRaphson(RealRootDerivFunction g, double x, double tol){
        ...
        while(testConv){
            ...
            iterN++;
            if(iterN>iterMax){
                System.out.println("RealRoot.newtonRaphson: maximum number of iterations exceeded - root at this point," + Fmath.truncate(x, 4) + ", returned");
                System.out.println("Last mid-point difference = " + Fmath.truncate(diff, 4) +  ", tolerance = " + tol);
                root = x;
                testConv = false;
            }
