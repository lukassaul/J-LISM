...
*
*   Copyright (c) February 2002, August 2006, December 2006, April 2007
*
*   PERMISSION TO COPY:
        ...
        if(this.lastMethod==38){
            ...
            for(int i=0; i<nT; i++){
                ...
                if(this.fixed[i]){
                    ...
                    fout.printtab(Fmath.truncate(coeff[ii],this.prec), this.field);
                    if(invertFlag){
                        fout.printtab(Fmath.truncate(coeffSd[ii],this.prec), this.field);
                        fout.printtab(Fmath.truncate(coeffSd[ii]*100.0D/coeff[ii],this.prec), this.field);
                    }
